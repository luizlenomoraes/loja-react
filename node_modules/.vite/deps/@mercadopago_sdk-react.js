...
function checkOptionObject(oldOption, newOption) {
  const checkOptionObject2 = Object.keys(oldOption).length === Object.keys(newOption).length && Object.keys(oldOption).every((key) => {
    return Object.prototype.hasOwnProperty.call(newOption, key) && oldOption[key] === newOption[key];
  });
  return checkOptionObject2;
}
var initMercadoPago = (publicKey, options) => {
  const injectFrontEndOption = Object.assign(Object.assign({}, options), { frontEndStack: "react" });
  MercadoPagoInstance.publicKey = publicKey !== MercadoPagoInstance.publicKey ? publicKey : MercadoPagoInstance.publicKey;
  MercadoPagoInstance.options = !checkOptionObject(MercadoPagoInstance.options, injectFrontEndOption) ? injectFrontEndOption : MercadoPagoInstance.options;
};
...
// node_modules/@mercadopago/sdk-react/coreMethods/createCardToken/index.js
...
// node_modules/@mercadopago/sdk-react/coreMethods/updateCardToken/index.js
